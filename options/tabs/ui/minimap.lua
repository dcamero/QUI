...
local function BuildMinimapTab(tabContent)
    ...
    GUI:SetSearchContext({tabIndex = 7, tabName = "Minimap", subTabIndex = 1, subTabName = "Minimap"})
...
local function BuildDatatextTab(tabContent)
    ...
    -- Set search context for auto-registration
    GUI:SetSearchContext({tabIndex = 7, tabName = "Minimap", subTabIndex = 2, subTabName = "Datatext"})
